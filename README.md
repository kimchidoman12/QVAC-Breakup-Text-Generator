# QVAC Breakup Text Generator

Describe the situation and an on-device AI drafts a kind, clear breakup text, with a deterministic gentleness meter.
...
Then open http://localhost:29353
